...
class UnusedImagesCleaner2
{
    ...
    private static $DestDirectory = '/home/mapsshop/domains/mapsshop.ru/public_html/pictures/fordel3';
    private static $TmpDirectory = '/home/mapsshop/domains/mapsshop.ru/public_html/cache';

    private static $AllFileTable = 'tmpTool4UnusedImagesAllFiles';
    private static $UsedFileTable = 'tmpTool4UnusedImagesUsedFiles';
    private static $UnusedFileTable = 'tmpTool4UnusedImagesUnUsedFiles';
    private static $UnusedListFilename = 'UnusedList4.txt';
    private static $AllListFilename = 'AllList4.txt';
...
SELECT filename FROM $AllFileTable WHERE filename NOT IN (SELECT filename FROM $UsedFileTable)";
    ...
    private static function CreateDirectoryFileListDb($SourceDirectory,$Level=0)
    {
        ...
        while (false !== ($CurrentFilename = readdir($DirectoryHandle)))
        {
            if(($CurrentFilename!='.') and ($CurrentFilename!='..'))
            {
