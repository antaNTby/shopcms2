...
class UnusedImagesCleaner2
{
    ...
    private static $AllFileTable = 'tmpTool2UnusedImagesAllFiles';
    private static $UsedFileTable = 'tmpTool2UnusedImagesUsedFiles';
    private static $UnusedFileTable = 'tmpTool2UnusedImagesUnUsedFiles';
    private static $UnusedListFilename = 'UnusedList2.txt';
    private static $SubDirs = array('blok2','cat','lmenu','main_pic','osn');
...
"CREATE TABLE `$UnusedFileTable`(  
  ...
  PRIMARY KEY (`filename`)
    ...
    static function GetSourceDirectoryFilenames()
    {
        ...
        $FileList = $TmpDirectory.'/'.'FileList2.txt';
