...
function niceform(nf) {
	...
	nf.add_select = function(obj) {this._select[this._select.length] = obj; selects(obj);obj.style.visibility="hidden";}
...
function inputCheck(el) { //extend Checkboxes
	...
	el.dummy.src = imagesPath + "blank.gif";
...
function textarea(el) { //extend Textareas
	...
	el.topLeft.src = imagesPath + "blank.gif";
	el.topLeft.className = "NFTextareaTopLeft";
	el.topRight = document.createElement('div');
	el.topRight.className = "NFTextareaTop";
	el.bottomLeft = document.createElement('img');
	el.bottomLeft.src = imagesPath + "blank.gif";
	...
	el.init = function(pos) {
		...
		for(var q = 0; q < this.options.length; q++) {
			...
			this.options[q].lnk.onclick = function() {
				...
				change_country_handler(this.ref.options[this.pos].text);return false; 
			}
		}
